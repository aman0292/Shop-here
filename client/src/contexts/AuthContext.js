...
export const AuthContextProvider = ({children}) => {
    ...
    useEffect(() => {
        ...
        (async function(){
           try {
            await axios.post("https://shop-here1.herokuapp.com/api/users/protection",{},{ headers:{
    ...
    async function signout(spinner,sidebar){
        ...
        try {
            const {status} = await axios.post("https://shop-here1.herokuapp.com/api/users/signout")
            if(status === 200){
